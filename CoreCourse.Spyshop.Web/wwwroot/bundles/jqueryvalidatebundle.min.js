...
*/
(function(n,t){var i={min:n.validator.methods.min,max:n.validator.methods.max,range:n.validator.methods.range};n.validator.methods.dateGlobalizeOptions={dateParseFormat:{skeleton:"yMd"}};n.validator.methods.number=function(i,r){var u=t.parseNumber(i);return this.optional(r)||n.isNumeric(u)};n.validator.methods.date=function(i,r){var u=t.parseDate(i,n.validator.methods.dateGlobalizeOptions.dateParseFormat);return this.optional(r)||u instanceof Date};n.validator.methods.min=function(n,r,u){var f=t.parseNumber(n);return i.min.call(this,f,r,u)};n.validator.methods.max=function(n,r,u){var f=t.parseNumber(n);return i.max.call(this,f,r,u)};n.validator.methods.range=function(n,r,u){var f=t.parseNumber(n);return i.range.call(this,f,r,u)}})(jQuery,Globalize);$(function(){function n(n){var t=/[.]/.exec(n)?/[^.]+$/.exec(n):undefined;return t!==undefined?(t[0]+"").toLowerCase():t.toLowerCase()}jQuery.validator.unobtrusive.adapters.add("uploadedimage",["extensions","extensionsmessage","maxlength","maxlengthmessage"],function(n){var t={extensions:n.params.extensions.split(","),maxlength:parseInt(n.params.maxlength),extensionsmessage:n.params.extensionsmessage,maxlengthmessage:n.params.maxlengthmessage};n.rules.uploadedImageAllowedFiles=t;n.rules.uploadedImageMaxFileSize=t;n.messages.uploadedImageAllowedFiles=t.extensionsmessage;n.messages.uploadedImageMaxFileSize=t.maxlengthmessage});jQuery.validator.addMethod("uploadedImageAllowedFiles",function(t,i,r){if(i.files.length===0)return!0;var u=n(i.files[0].name);return $.inArray(u,r.extensions)!==-1});jQuery.validator.addMethod("uploadedImageMaxFileSize",function(n,t,i){if(t.files.length===0)return!0;var r=t.files[0].size;return r<=i.maxlength*1024})}(jQuery));$(function(){jQuery.validator.unobtrusive.adapters.add("mustbetrue",[],function(n){n.rules.required=!0;n.messages&&(n.messages.required=n.message)})}(jQuery));
//# sourceMappingURL=jqueryvalidatebundle.min.js.map