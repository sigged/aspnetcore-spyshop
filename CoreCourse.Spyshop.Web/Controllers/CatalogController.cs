...
namespace CoreCourse.Spyshop.Web.Controllers
{
    public class CatalogController : Controller
    {
        ...
        public CatalogController()
        {
            ...
            {
                new Product{ Category = categories[0],
                    Name = "Contactlenses", Price =13.95M,
                    Description = "The lenses allow to zoom up to 5 km." },
                new Product{ Category = categories[0],
                    Name = "Card game", Price =70.95M,
            ...
            {
                new Product{ Category = categories[1],
                    Name = "Holographic cushion", Price=55.45M,
